...
export default class CardModal extends Component {
  ...
  renderBottom() {
    ...
    var plusButton = !this.state.activated ? (
      <Animated.View
        style={{ opacity: this.state.plus, justifyContent: 'center', alignItems: 'center' }}
      >
      ...
      >
        <View style={{ flexDirection: 'row' }}>
          <View style={{ flex: 4 }}>
            ...
            <Text style={{ fontSize: 12, fontWeight: '500', color: 'gray', paddingBottom: 10 }}>
  ...
  render() {
    return (
      <View style={[styles.container, this.state.pressedStyle]}>
        <TouchableWithoutFeedback onPress={!this.state.pressed ? this._onPress : null}>
